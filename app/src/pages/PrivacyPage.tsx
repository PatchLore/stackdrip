export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-20 text-sm">
      ...
      <p className="mb-4">Payment processing handled by Stripe. We do not store credit card information. GitHub usernames collected solely for repository transfer purposes.</p>
