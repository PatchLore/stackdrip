...
const faqs = [
  {
    ...
    answer: `Templates are static. These are production apps—working auth, working Stripe, working databases. You get the repo, the deployment config, and 7 days of email support to get it live.`,
  },
  {
  ...
  },
  {
    ...
    answer: `You get email support for 7 days. Bug fixes guaranteed. Want custom dev? That's a separate conversation, but these apps are built to be forked easily.`,
  },
  {
